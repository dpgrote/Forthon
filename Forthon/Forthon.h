...
static struct PyMethodDef ForthonPackage_methods[] = {
  {"addvarattr"  , (PyCFunction)ForthonPackage_addvarattr, METH_VARARGS, addvarattr_doc},
  {"allocated"   , (PyCFunction)ForthonPackage_allocated, METH_VARARGS, allocated_doc},
  {"deprefix"    , (PyCFunction)ForthonPackage_deprefix, METH_VARARGS, deprefix_doc},
  {"forceassign" , (PyCFunction)ForthonPackage_forceassign, METH_VARARGS, forceassign_doc},
  {"gallot"      , (PyCFunction)ForthonPackage_gallot, METH_VARARGS, gallot_doc},
  {"gchange"     , (PyCFunction)ForthonPackage_gchange, METH_VARARGS, gchange_doc},
  {"getdict"     , (PyCFunction)ForthonPackage_getdict, METH_VARARGS, getdict_doc},
  {"getfobject"  , (PyCFunction)ForthonPackage_getfobject, METH_VARARGS, getfobject_doc},
  {"getfunctions", (PyCFunction)ForthonPackage_getfunctions, METH_VARARGS, getfunctions_doc},
  {"getgroup"    , (PyCFunction)ForthonPackage_getgroup, METH_VARARGS, getgroup_doc},
  {"getpyobject" , (PyCFunction)ForthonPackage_getpyobject, METH_VARARGS, getpyobject_doc},
  {"gettypename" , (PyCFunction)ForthonPackage_gettypename, METH_VARARGS, gettypename_doc},
  {"getvarattr"  , (PyCFunction)ForthonPackage_getvarattr, METH_VARARGS, getvarattr_doc},
  {"setvarattr"  , (PyCFunction)ForthonPackage_setvarattr, METH_VARARGS, setvarattr_doc},
  {"delvarattr"  , (PyCFunction)ForthonPackage_delvarattr, METH_VARARGS, delvarattr_doc},
  {"getvardoc"   , (PyCFunction)ForthonPackage_getvardoc, METH_VARARGS, getvardoc_doc},
  {"getvarunit"  , (PyCFunction)ForthonPackage_getvarunit, METH_VARARGS, getvarunit_doc},
  {"gfree"       , (PyCFunction)ForthonPackage_gfree, METH_VARARGS, gfree_doc},
  {"gsetdims"    , (PyCFunction)ForthonPackage_gsetdims, METH_VARARGS, gsetdims_doc},
  {"isdynamic"   , (PyCFunction)ForthonPackage_isdynamic, METH_VARARGS, isdynamic_doc},
  {"getvartype"  , (PyCFunction)ForthonPackage_getvartype, METH_VARARGS, getvartype_doc},
  {"listvar"     , (PyCFunction)ForthonPackage_listvar, METH_VARARGS, listvar_doc},
  {"name"        , (PyCFunction)ForthonPackage_name, METH_VARARGS, name_doc},
  {"reprefix"    , (PyCFunction)ForthonPackage_reprefix, METH_VARARGS, reprefix_doc},
  {"setdict"     , (PyCFunction)ForthonPackage_setdict, METH_VARARGS, setdict_doc},
