...
PyArrayObject* FARRAY_FROMOBJECT(PyObject *A2, int ARRAY_TYPE) {
  PyArrayObject *A1;
  PyArray_Descr *descr;
...
int Forthon_checksubroutineargtype(PyObject *pyobj,int type_num)
{
  int ret;
...
void Forthon_restoresubroutineargs(int n,PyObject **pyobj, PyArrayObject **ax)
{
  int i,ret;
...
void Forthon_BuildDicts(ForthonObject *self)
{
  int i;
...
void Forthon_DeleteDicts(ForthonObject *self)
{
...
void ForthonPackage_allotdims(ForthonObject *self)
{
  int i;
  for (i=0;i<self->narrays;i++) {
...
/* static array. */
void ForthonPackage_staticarrays(ForthonObject *self)
{
  int i;
  char *c;
...
PyObject *ForthonPackage_gallot(PyObject *_self_,PyObject *args)
{
  ForthonObject *self = (ForthonObject *)_self_;
  char *s=NULL;
  long i;
